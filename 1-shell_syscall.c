...
/**
* ctrl_C - the signal to exit prompt on new line
...
/**
* shell_execute - execute the command passed
...
/**
* check_command - check the type of the command passed
...
/**
* execute - the function that execute the command
